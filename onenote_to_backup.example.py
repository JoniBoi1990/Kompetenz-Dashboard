...
SITE_URL = "https://meineschule.sharepoint.com/sites/KlXXChYY2526"
NOTEBOOK_NAME = "XX Ch YY 2526-Notizbuch"   # Exakter Name des Notizbuchs

# Dashboard-URL für ID-Abgleich (leer = lokale JSON-Datei als Fallback)
DASHBOARD_URL = "https://mein-dashboard.uber.space"
...
CLASS_ID = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
CLASS_NAME = "9"
GRADE_LEVEL = 9
COMPETENCY_LIST_ID = "klasse-9-chemie"
CREATED_BY = "lehrer@meineschule.de"

# Schülernamen (wie im OneNote-Abschnittsnamen) → UPN/E-Mail im Dashboard
STUDENT_UPN_MAP: dict[str, str] = {
    # Abschnittsname im Notizbuch (exakt!) → UPN/E-Mail im Dashboard
    # Sonderfälle:
    #   Umlaute:       ä→ae, ö→oe, ü→ue, ß→ss  (je nach Schul-UPN-Schema prüfen)
    #   Mehrere Vornamen: nur den in der E-Mail genutzten Vornamen
    #   Spitznamen in Klammern: ignorieren
    #   Adelsprädikate: z.B. "von" → ggf. im UPN enthalten oder nicht
    "Mustermann, Max":           "max.mustermann@s.meineschule.de",
    "Beispiel, Anna":            "anna.beispiel@s.meineschule.de",
    "Müller, Sören":             "soeren.mueller@s.meineschule.de",   # ⚠ Umlaut — bitte prüfen
    "Schmidt, Eva Maria":        "eva.schmidt@s.meineschule.de",      # ⚠ mehrere Vornamen — bitte prüfen
    "Liu, Tianshuo (Leo)":       "tianshuo.liu@s.meineschule.de",     # ⚠ Spitzname ignoriert — bitte prüfen
    # ... weitere Schüler eintragen ...
}
